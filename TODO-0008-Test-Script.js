...
async function CheckAllItemsInItemList() {
    ...
    try{
        ...
        await driver.findElement(By.id('todo-input')).sendKeys('abcd127');
        ...
        await driver.findElement(By.id('todo-input')).sendKeys('koko109');

        await driver.findElement(By.id('todo-input')).sendKeys(Key.RETURN);
        
        await driver.findElement(By.id('todo-input')).click();
        await driver.findElement(By.id('todo-input')).clear();
        await driver.findElement(By.id('todo-input')).sendKeys('%^%$tosses');
        ...
        //8. Click “Active” or “Complete” Tab.

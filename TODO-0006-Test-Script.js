...
/*This is Automation Test Script for TODO-0006 Test Case -- 
Check one or more Items in To-do Items List in All Tab*/ 
async function CheckItemsInItemList() {
    ...
    try{
        ...
        await driver.findElement(By.id('todo-input')).sendKeys('koko1919');

        await driver.findElement(By.id('todo-input')).sendKeys(Key.RETURN);
        
        await driver.findElement(By.id('todo-input')).click();
        await driver.findElement(By.id('todo-input')).clear();
        await driver.findElement(By.id('todo-input')).sendKeys('%^%$tests');
